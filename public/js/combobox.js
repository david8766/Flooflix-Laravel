...
function ComboBox(e, l) {
    ...
    this.list.onchange = function () {
        return this.comboBox.updateList2EditField();
    };
    this.list.onblur = function () {
        return this.comboBox.initCloseComboBoxList();
    };
    this.list.onfocus = function () {
        return this.comboBox.onfocusComboBoxList();
    };

    this.editField.onfocus = function () {
        return this.comboBox.openComboBoxList();
    };
    this.editField.onblur = function () {
        return this.comboBox.initCloseComboBoxList();
    };
    this.editField.onkeyup = function () {
        return this.comboBox.searchEditFieldIn2List();
    };
}
...
new ComboBox(document.getElementById('comboBoxEditField3'), document.getElementById('comboBoxList3'));
new ComboBox(document.getElementById('comboBoxEditField4'), document.getElementById('comboBoxList4'));
new ComboBox(document.getElementById('comboBoxEditField5'), document.getElementById('comboBoxList5'));
new ComboBox(document.getElementById('comboBoxEditField6'), document.getElementById('comboBoxList6'));
new ComboBox(document.getElementById('comboBoxEditField7'), document.getElementById('comboBoxList7'));
new ComboBox(document.getElementById('comboBoxEditField8'), document.getElementById('comboBoxList8'));
new ComboBox(document.getElementById('comboBoxEditField9'), document.getElementById('comboBoxList9'));
new ComboBox(document.getElementById('comboBoxEditField10'), document.getElementById('comboBoxList10'));